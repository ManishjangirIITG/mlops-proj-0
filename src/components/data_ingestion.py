...
from src.data_access.proj0_data import Proj0Data
from src.constants import DATABASE_NAME

class DataIngestion:
    def __init__(self, data_ingestion_config: DataIngestionConfig = DataIngestionConfig()):
        """
        :params data_ingestion_config: configuration for data ingestion
        """
        try:
    ...
    def split_data_as_train_test(self, dataframe: DataFrame) -> None:
        """
        Splits the dataframe into train set and test set based on split ratio

        Output      : The folder is created in s3 bucket
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        Output      : train set and test set are returned as the artifacts of the data ingestion component
        On failure  : Write an exception log and raise an exception
        """
